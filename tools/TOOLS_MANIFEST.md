...
| [`test-io-controller-output.js`](test-io-controller-output.js) | Exercises output buffering, status/topbar behavior, input handling, save/load flows, visited-map discovery, and interpreter UI commands. | [`../docs/INTERPRETER_EXTENSIONS.md`](../docs/INTERPRETER_EXTENSIONS.md); save storage context: [`../docs/QUETZAL_LOCAL_STORAGE.md`](../docs/QUETZAL_LOCAL_STORAGE.md); map runtime context: [`../docs/IN_GAME_VISITED_MAP.md`](../docs/IN_GAME_VISITED_MAP.md). |
