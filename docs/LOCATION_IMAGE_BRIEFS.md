...
1. `Small Courtyard (16)`
   - Title: `Small Courtyard: Supplemental Study (16)`
...
2. `Cinderblock Tunnel (17)`
   - Title: `Cinderblock Tunnel: Supplemental Study (17)`
...
6. `Tunnel Entrance (34)`
   ...
   - Description: Use the literal room text as the primary layout guide, with emphasis on: The tunnel continues west from here, becoming narrow, muddy, and forbidding.

7. `Stairway (35)`
   - Title: `Stairway: Supplemental Study (35)`
...
8. `Concrete Box (37)`
   - Title: `Concrete Box: Supplemental Study (37)`
...
9. `Engineering Building (38)`
   - Title: `Engineering Building: Supplemental Study (38)`
...
10. `Lab (42)`
   - Title: `Lab: Supplemental Study (42)`
...
11. `Dead Storage (47)`
   - Title: `Dead Storage: Supplemental Study (47)`
...
17. `Third Floor (110)`
   - Title: `Third Floor: Supplemental Study (110)`
...
24. `Fruits and Nuts (150)`
   - Title: `Fruits and Nuts: Supplemental Study (150)`
...
29. `Department of Alchemy (174)`
   - Title: `Department of Alchemy: Supplemental Study (174)`
...
30. `Cluttered Passage (179)`
   - Title: `Cluttered Passage: Supplemental Study (179)`
...
37. `Top Floor (195)`
   - Title: `Top Floor: Supplemental Study (195)`
...
38. `Brown Basement (200)`
   - Title: `Brown Basement: Supplemental Study (200)`
...
39. `Temporary Basement (202)`
   - Title: `Temporary Basement: Supplemental Study (202)`
...
40. `Infinite Corridor (206)`
   - Title: `Infinite Corridor: Supplemental Study (206)`
...
41. `Infinite Corridor (208)`
   - Title: `Infinite Corridor: Supplemental Study (208)`
...
42. `Infinite Corridor (210)`
   - Title: `Infinite Corridor: Supplemental Study (210)`
...
43. `Top of Dome (213)`
   - Title: `Top of Dome: Supplemental Study (213)`
...
44. `Infinite Corridor (214)`
   - Title: `Infinite Corridor: Supplemental Study (214)`
   - Literal description: `The so-called infinite corridor runs from east to west in the main campus building. The corridor extends both ways from here. Many closed and locked offices are to the north and south.`
   - Description: Use the literal room text as the primary layout guide, with emphasis on: The so-called infinite corridor runs from east to west in the main campus building.
...
51. `Chemistry Building (248)`
   - Title: `Chemistry Building: Supplemental Study (248)`
