...
2. [pending] Study Z-Machine Standard 1.1 - File Format & Z3 Specifics
   - Read official specification (https://www.inform-fiction.org/zmachine/standards/z1point1/index.html)
   - Document Z3 header format and memory layout
   - Create reference guide for opcodes and data structures
   - Maps to file structure of The Lurking Horror

3. [pending] Analyze ifvms.js architecture and core algorithms
...
4. [pending] Design Phase 1 implementation (Foundation)
...
5. [pending] Phase 1: Build Z3 file parser
...
6. [pending] Phase 1: Implement Z-machine VM core
...
7. [pending] Phase 1: Create HTML/CSS UI framework
