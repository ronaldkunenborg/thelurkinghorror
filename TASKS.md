...
51. [pending] Refine de prototype kaart verder in een tweede prototype.
...
52. [pending] Add an in-game map of visited locations while adventuring.
...
53. [pending] implement hints-booklet foundation from `docs/BOOKLET_HINTS_IMPLEMENTATION_PLAN.md` (booklet pages 1-4).
